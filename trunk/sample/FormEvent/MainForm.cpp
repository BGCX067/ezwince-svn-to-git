...
{
	AddDestroyEvent(this, (WM_DESTROY_EVENT_HANDLER)&MainForm::OnDestroy);	
	AddPaintEvent(this,(WM_PAINT_EVENT_HANDLER)&MainForm::OnPaint);
	AddCreateEvent(this,(WM_CREATE_EVENT_HANDLER)&MainForm::OnCreate);
